...
"""RSIQUI V3 NEG variant.

NEG preserves the operator-supplied root RSIQUI V3 entry/signal logic. Negative
reward:risk behavior belongs in JSON/runner money contract fields, not in the
entry condition implementation.
"""
