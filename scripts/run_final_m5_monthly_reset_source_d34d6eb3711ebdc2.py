...
CONFIG_PATH = ROOT / "configs" / "strategies" / "rsiqui" / "final_m5_monthly_reset_source_d34d6eb3711ebdc2.json"
SYMBOL = "XAUUSD"
TIMEFRAME = "5m"
...
def main() -> None:
    ...
    strategy_name = "builtin_rsiqui-v3-final_gold-loose_both_vol0.04_risk20_reward20_spreadcap0.5_comm0.16_monthly_reset_source_d34d6eb3711ebdc2_M5"
