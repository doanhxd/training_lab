...
def main() -> None:
    ...
    if payload["strategy"] != "rsiqui-v3-final" or payload.get("symbol", SYMBOL) != SYMBOL or str(payload["timeframe"]).upper() not in {"M5", "5M"}:
    ...
    config_payload = config.__dict__ | {
        ...
        "requested_period_utc": "2025-01-01T00:00:00Z..now",
    ...
    strategy_name = "builtin_rsiqui-v3-final_gold-loose_both_vol0.04_risk40_reward20_closeconfirm_blackout_2to7_M5_20250101_present"
