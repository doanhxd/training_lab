...
CONFIG_PATH = ROOT / "configs" / "strategies" / "rsiqui" / "final_m5_monthly_reset_source_bfe2e60ab32490e6.json"
SYMBOL = "XAUUSD"
TIMEFRAME = "5m"
...
def main() -> None:
    ...
    strategy_name = "builtin_rsiqui-v3-final_gold-loose_both_vol0.02_risk20_reward5_spreadcap0.5_comm0.00_monthly_reset_source_bfe2e60ab32490e6_M5"
