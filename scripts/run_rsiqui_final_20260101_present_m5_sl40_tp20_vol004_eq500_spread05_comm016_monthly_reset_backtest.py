...
SOURCE_CONFIG = ROOT / "configs" / "strategies" / "rsiqui" / "backtests" / "final_m5_backtest_20260101_present_sl40_tp20_vol004_eq500_spread05_comm016_monthly_reset.json"
...
NEW_STRATEGY_LITERAL = 'builtin_rsiqui-v3-final_gold-loose_both_vol0.04_risk40_reward20_spreadcap0.5_comm0.16_monthly_reset_closeconfirm_blackout_gmt7_M5_20260101_present'

source = BASE_RUNNER.read_text(encoding="utf-8")
for literal, label in ((OLD_CONFIG_LITERAL, "config"), (OLD_STRATEGY_LITERAL, "strategy")):
