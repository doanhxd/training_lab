...
RAW_PATH = ROOT / "data" / "raw" / "mt5_exports" / "BTCUSD_M5_202601010005_202608020925.csv"
CONFIG_PATH = ROOT / "configs" / "strategies" / "rsiqui" / "btcusd_negative_r_m5_demo.json"
SYMBOL = "BTCUSD"
TIMEFRAME = "5m"
...
def main() -> None:
    ...
    config_payload = asdict(config) | {
        ...
        "optimization_policy": f"none: no parameter search/overfit; fixed root RSIQUI BTCUSD signal, volume {float(payload['volume']):g} lot, SL ${float(payload['risk_usd']):g}, TP ${float(payload['reward_usd']):g}, max_spread from JSON",
    }
    strategy_name = (
        ...
        f"M5_2026-01-01_to_2026-08-02_0925_initial2000_negativeR_closeconfirm_spreadcap{float(payload['max_spread']):g}_"
    ...
    artifacts = persist_run_artifacts(
        ...
        raw_spec={
            ...
            "period": "2026-01-01 00:05:00 UTC..2026-08-02 09:25:00 UTC",
