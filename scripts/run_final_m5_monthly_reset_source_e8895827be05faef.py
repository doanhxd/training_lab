...
CONFIG_PATH = ROOT / "configs" / "strategies" / "rsiqui" / "final_m5_monthly_reset_source_e8895827be05faef.json"
SYMBOL = "XAUUSD"
TIMEFRAME = "5m"
...
def main() -> None:
    ...
    strategy_name = "builtin_rsiqui-v3-final_gold-loose_both_vol0.03_risk24_reward9_spreadcap0.4_comm0.00_monthly_reset_source_e8895827be05faef_M5"
