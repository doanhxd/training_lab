...
CONFIG_PATH = ROOT / "configs" / "strategies" / "rsiqui" / "backtests" / "final_m5_backtest_20260101_present_sl30_tp15_vol003_eq1000.json"
SYMBOL = "XAUUSD"
TIMEFRAME = "5m"
...
def main() -> None:
    ...
    config = rsiqui_v3_config_for_preset(
        payload["preset"],
        initial_equity=float(payload["initial_equity"]), volume_lots=float(payload["volume"]),
    ...
    strategy_name = "builtin_rsiqui-v3-final_gold-loose_both_vol0.03_risk30_reward15_closeconfirm_blackout_gmt7_M5_20260101_present"
