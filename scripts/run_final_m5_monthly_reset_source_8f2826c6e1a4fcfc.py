...
RAW_PATH = ROOT / "data" / "raw" / "mt5_exports" / "XAUUSD_M5_202601020100_202607312355.csv"
CONFIG_PATH = ROOT / "configs" / "strategies" / "rsiqui" / "final_m5_monthly_reset_source_8f2826c6e1a4fcfc.json"
SYMBOL = "XAUUSD"
TIMEFRAME = "5m"
...
def main() -> None:
    ...
    strategy_name = "builtin_rsiqui-v3-final_gold-loose_both_vol0.03_risk30_reward15_spreadcap0.2_comm0.00_monthly_reset_source_8f2826c6e1a4fcfc_M5"
