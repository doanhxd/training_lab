...
def main() -> None:
    ...
    strategy_name = (
        ...
        f"original_unfiltered_M5_2026_to_present_spreadx{float(payload['spread_multiplier']):g}_"
    ...
    artifacts = persist_run_artifacts(
        run_id=run_id,
        raw_spec={"strategy": payload["strategy"], "source": "final.py_original_unmodified", "raw_path": str(RAW_PATH)},
