...
CONFIG_PATH = ROOT / "configs" / "strategies" / "rsiqui" / "backtests" / "final_m5_backtest_20260101_present_sl27_tp9_vol003_eq1000.json"
SYMBOL = "XAUUSD"
TIMEFRAME = "5m"
...
def main() -> None:
    ...
    strategy_name = "builtin_rsiqui-v3-final_gold-loose_both_vol0.03_risk27_reward9_closeconfirm_blackout_gmt7_M5_20260101_present"
