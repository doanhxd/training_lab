...
RAW_PATH = ROOT / "data" / "raw" / "mt5_exports" / "XAUUSD_M5_202601012305_202607310925.csv"
...
def main() -> None:
    ...
    strategy_name = (
        ...
        f"original_unfiltered_M5_2026_07_spreadcap{SPREAD_CAP:g}_spreadx{float(payload['spread_multiplier']):g}_"
    ...
    metadata = {
        ...
        "limitations": [
            "July-only spread cap $0.40 run. final.py is the original/unfiltered RSIQUI implementation and uses numpy.gradient centered-gradient behavior; label as FORENSIC/original, not causal live-ready evidence.",
    ...
    artifacts = persist_run_artifacts(
        run_id=run_id,
        raw_spec={"strategy": payload["strategy"], "source": "final.py_original_unmodified", "raw_path": str(RAW_PATH), "period": "2026-07-01..2026-07-31", "max_spread_override": SPREAD_CAP},
